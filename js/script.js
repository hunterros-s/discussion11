...
// Question 1
document.getElementById("host-name").innerHTML = "Hunter Ross";
document.getElementById("collaborator-name").innerHTML = "Sarah Ghalmi";
...
document.getElementById("first_name").addEventListener("input", (input) => {
    console.log(input);
    if (input == "John")
    {
